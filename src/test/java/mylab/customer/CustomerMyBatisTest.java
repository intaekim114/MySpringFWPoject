...
@ContextConfiguration(locations = {"classpath:spring-beans-mybatis.xml","classpath:mylab-customer-mybatis.xml"})
public class CustomerMyBatisTest {
	...
	public void insert() {
		customerService.insertCustomer(
				new CustomerVO("customer1@gmail.com", "짱구", 15));
		customerService.insertCustomer(
				new CustomerVO("customer2@gmail.com", "철수", 20));
	}
	...
	public void sqlSessionTest(){
		...
		List<CustomerVO> list = 
				sqlSession.selectList("mylab.customer.dao.mapper.CustomerMapper.selectAllCustomer");
	...
	public void customerMapperTest(){
		CustomerVO customer = 
				customerMapper.selectCustomerByEmail("customer1@gmail.com");
		System.out.println(customer);
		assertEquals("짱구", customer.getName());
	}
